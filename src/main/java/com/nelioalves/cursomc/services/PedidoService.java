...
public class PedidoService {
	...
	public Pedido insert(Pedido obj) {
		...
		if (obj.getPagamento() instanceof PagamentoComBoleto) {
			...
			boletoService.preencherPgamentoComBoleto(pagto, obj.getInstante());
		}
	...
	public Page<Pedido> findPage(Integer page, Integer linesPerPage, String orderBy, String direct) {
